...
export default function Sidebar({ role, plan, active, onNav, onExit, mobileOpen, setMobileOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:sticky top-0 h-screen w-64 bg-navy-950 text-white flex flex-col z-50 transition-transform duration-300 shrink-0 relative overflow-hidden
